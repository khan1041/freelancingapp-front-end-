...
import Reg from './mern1.jsx/Reg'
import Login1 from './mern1.jsx/Login'
import Home1 from './mern1.jsx/Home1'
import Nav1 from './mern1.jsx/Nav1'
import Aout from './mern1.jsx/Aout'
import { Logout } from './mern1.jsx/Logout1'
import { useAuth1 } from './Context/AuthProvider'
//import Suvice from './ourproject/Suvice'
//import Homepage from './ourproject/Homepage'
import Detailspage from './mern1.jsx/Detailspage'
import Freedetails from './mern1.jsx/Freedetails'
import React,{Suspense} from 'react'
const Homepage=React.lazy(()=>import('./mern1.jsx/Homepage'))
const Conteact=React.lazy(()=>import('./pages/Conteact'))
const Service=React.lazy(()=>import('./mern1.jsx/Suvice'))
function App() {
